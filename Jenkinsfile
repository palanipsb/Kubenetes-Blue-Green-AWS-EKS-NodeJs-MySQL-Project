pipeline {
    ...
    environment {
        IMAGE_NAME = "palanipsb/nodejswebapp"
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', credentialsId: 'git-cred', url: 'https://github.com/palanipsb/Kubenetes-Blue-Green-AWS-EKS-NodeJs-MySQL-Project.git'
            }
        }
